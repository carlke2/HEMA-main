<template>
  <section class="bg-white">
    <LandingNav />
    <div class="container px-6 py-12 mt-20 mx-auto">
      <div>
      ...
      <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
        <!-- 👇 THIS IS NOW VERTICAL -->
        <div class="grid grid-cols-1 gap-12">
          <div>
            <span
              class="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80"
            >
              <svg
        ...
        <div class="overflow-hidden rounded-lg lg:col-span-2 h-96 lg:h-auto">
          <iframe
            ...
            marginwidth="0"
            scrolling="no"
            src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=Nairobi+(Hema)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed"
          >
          </iframe>
        </div>
      </div>
